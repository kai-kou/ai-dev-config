...
description: スキャン結果を集約してダッシュボード（DASHBOARD.md）を生成するサブエージェント。
model: sonnet-4.5
---
...
オーケストレーターから以下を受け取ります：
- 各プロジェクトのスキャン結果（scan-projectの出力）
...
**生成方法**: Cursor AI（project-analyzer）
...
Cursorで「ダッシュボード更新」と言うと自動更新されます。
```
