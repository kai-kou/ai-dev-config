...
model: sonnet # converted from grok-code: 非Anthropicモデル→sonnetに正規化
maxTurns: 15
...
以下のMarkdown形式でリスク・制約分析レポートを作成し、戻り値として返してください。ファイル保存は親エージェント（reqdef）が行います。
...
| # | 制約 | 現実性 | 変動可能性 | 矛盾 | 備考 |
|---|------|--------|-----------|------|------|
| 1 | [制約] | [評価] | 高/中/低 | なし/あり | [備考] |

## 4. リスク一覧

| # | リスク | カテゴリ | 発生確率 | 影響度 | 評価 | 対策 |
|---|--------|---------|---------|--------|------|------|
| 1 | [リスク名] | [カテゴリ] | 高/中/低 | 高/中/低 | 極高/高/中/低 | [対策パターン] |
